    ...
    return (
        <>
            <div className="fixed flex justify-center items-center left-0 right-0 bottom-0 top-0 text-white z-[999]">
                <div onClick={() => setConfirmModal(false)} className="fixed left-0 right-0 bottom-0 top-0 bg-black opacity-60">
                </div>
                ...
                <div className="m-auto p-10 max-w-[400px] max-h-[280px] sm:max-h-[230px] w-full h-full z-10 bg-[#151515] rounded-md">
                    ...
                    <div className="flex-col sm:flex-row flex items-center justify-center gap-4 mt-4">
                        <button onClick={() => setConfirmModal(false)} className="bg-[#E82127] h-[40px] w-full rounded-sm">Cancel</button>
                        <button onClick={() => setConfirmModal(false)} className="bg-[#A5FF2B] h-[40px] w-full rounded-sm text-black">Confirm</button>
                    </div>
                </div>
            </div>
        </>
